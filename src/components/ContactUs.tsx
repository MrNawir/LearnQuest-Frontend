              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:contact@learnquest.com" className="text-accent font-bold hover:underline">contact@learnquest.com</a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="https://wa.me/254712345678" className="text-accent font-bold hover:underline">+254 712 345 678</a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground font-medium">123 Innovation Drive, Nairobi, Kenya</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="p-8 bg-card rounded-3xl border border-border shadow-sm">
              ...
              <div className="space-y-4">
                <details className="group">
                  <summary className="flex items-center justify-between font-medium cursor-pointer list-none text-foreground hover:text-accent transition-colors">
            ...
            {isSent ? (
              <div className="h-full flex flex-col items-center justify-center text-center py-12">
                ...
                <button 
                  ...
                  className="px-6 py-2 bg-secondary text-secondary-foreground rounded-xl font-bold hover:bg-secondary/80 transition-colors"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input 
                      ...
                      className="w-full px-4 py-3 bg-secondary/20 border border-border rounded-xl focus:ring-2 focus:ring-accent/20 focus:border-accent outline-none transition-all"
                    />
                  </div>
                  <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <textarea 
                    ...
                    className="w-full px-4 py-3 bg-secondary/20 border border-border rounded-xl focus:ring-2 focus:ring-accent/20 focus:border-accent outline-none transition-all resize-none"
                  />
                </div>
                ...
                <button 
                  ...
                  className="w-full py-4 bg-accent text-white rounded-xl font-bold text-lg shadow-xl shadow-accent/20 hover:shadow-2xl hover:shadow-accent/30 hover:-translate-y-1 transition-all disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                >
                  {isSubmitting ? (
                    <>Sending...</>
                  ) : (
